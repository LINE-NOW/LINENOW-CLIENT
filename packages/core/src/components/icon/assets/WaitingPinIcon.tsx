...
interface WaitingPinIconProps extends IconAssetProps {
  label?: string;
}

const WaitingPinIcon = (props: WaitingPinIconProps) => {
  const { color = "black", size = 24, label = "운영 전" } = props;
  const isOperating: boolean = false;
